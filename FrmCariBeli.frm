...
With lvw
    ...
    .SubItems(3) = rscaribarang!HARGA_BELI
...
Private Sub ListView1_DblClick()
    ...
    FrmKulak.txtKode.Text = ListView1.ListItems(ListView1.SelectedItem.Index).SubItems(1)
    FrmKulak.txtNama.Text = ListView1.ListItems(ListView1.SelectedItem.Index).SubItems(2)
    FrmKulak.txtHarga.Text = ListView1.ListItems(ListView1.SelectedItem.Index).SubItems(3)
    FrmKulak.cmbSatuan.Text = ListView1.ListItems(ListView1.SelectedItem.Index).SubItems(5)
    FrmKulak.Show
    Unload Me
    End If
End Sub
